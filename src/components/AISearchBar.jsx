...
const InnerContainer = styled.div`
  ...
  &:focus-within {
    /* soft, spread-out bluish glow */
    box-shadow: 0 0 40px 15px rgba(0, 150, 255, 0.25);
  }
`;
...
const SearchInput = styled.input`
  flex: 1;
  padding: 28px 25px; /* more height for typing */
  border: none;
  font-size: 0.95em;
  ...
  return (
    <SearchContainer>
      <InnerContainer>
        <SearchInput
          type="text"
          placeholder="Predict the next fashion trend"
          value={searchTerm}
